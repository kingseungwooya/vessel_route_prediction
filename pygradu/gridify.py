...
def area_to_grid(north_east=shapely.geometry.Point(134, 40), south_west=shapely.geometry.Point(123, 32), side_length=50, proj_from='epsg:4326', proj_to='EPSG:5181'):
    # Set up projections
